...
export const UNISWAP_HOTPOT_ETH_PAIR_FIRST_LIQUDITY_BLOCK = BigInt.fromI32(10750005)

export const ACC_HOTPOT_PRECISION = BigInt.fromString('1000000000000')
...
export const MASTER_CHEF_V2_ADDRESS = Address.fromString('0xB4286F416e692E0faf847CFd584f0111949364eE')

export const HOTPOT_BAR_ADDRESS = Address.fromString(
  '{{ hotpot_bar_address }}{{^hotpot_bar_address}}0x0000000000000000000000000000000000000000{{/hotpot_bar_address}}'
)

export const HOTPOT_MAKER_ADDRESS = Address.fromString(
  '{{ hotpot_maker_address }}{{^hotpot_maker_address}}0x0000000000000000000000000000000000000000{{/hotpot_maker_address}}'
)

export const HOTPOT_TOKEN_ADDRESS = Address.fromString(
  '{{ hotpot_address }}{{^hotpot_address}}0x0000000000000000000000000000000000000000{{/hotpot_address}}'
)

export const HOTPOT_USDT_PAIR_ADDRESS = Address.fromString(
  '{{ hotpot_usdt_pair_address }}{{^hotpot_usdt_pair_address}}0x0000000000000000000000000000000000000000{{/hotpot_usdt_pair_address}}'
)

export const XHOTPOT_USDC_PAIR_ADDRESS = Address.fromString(
  '{{ xhotpot_usdc_pair_address }}{{^xhotpot_usdc_pair_address}}0x0000000000000000000000000000000000000000{{/xhotpot_usdc_pair_address}}'
)

export const XHOTPOT_WETH_PAIR_ADDRESS = Address.fromString(
  '{{ xhotpot_weth_pair_address }}{{^xhotpot_weth_pair_address}}0x0000000000000000000000000000000000000000{{/xhotpot_weth_pair_address}}'
)

export const HOTPOT_DISTRIBUTOR_ADDRESS = Address.fromString(
  '{{ hotpot_distributor_address }}{{^hotpot_distributor_address}}0x0000000000000000000000000000000000000000{{/hotpot_distributor_address}}'
)
...
export const HOTPOT_USDT_PAIR =
  '{{ hotpot_usdt_pair }}{{^hotpot_usdt_pair}}0x0000000000000000000000000000000000000000{{/hotpot_usdt_pair}}'
...
export const HOTPOTSWAP_WETH_USDT_PAIR_ADDRESS = Address.fromString(
  '{{ hotpotswap_weth_usdt_pair_address }}{{^hotpotswap_weth_usdt_pair_address}}0x0000000000000000000000000000000000000000{{/hotpotswap_weth_usdt_pair_address}}'
)
...
export const UNISWAP_HOTPOT_ETH_PAIR_ADDRESS = Address.fromString(
  '{{ uniswap_hotpot_eth_pair_address }}{{^uniswap_hotpot_eth_pair_address}}0x0000000000000000000000000000000000000000{{/uniswap_hotpot_eth_pair_address}}'
)

export const UNISWAP_HOTPOT_USDT_PAIR_ADDRESS = Address.fromString(
  '{{ uniswap_hotpot_usdt_pair_address }}{{^uniswap_hotpot_usdt_pair_address}}0x0000000000000000000000000000000000000000{{/uniswap_hotpot_usdt_pair_address}}'
)

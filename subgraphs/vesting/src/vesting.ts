...
import { HotpotDistributor, Claimed } from '../generated/HotpotDistributor/HotpotDistributor'
import { User, Claim, Week } from '../generated/schema'
import { BIG_DECIMAL_ZERO, BIG_DECIMAL_1E18, BIG_INT_ZERO, HOTPOT_DISTRIBUTOR_ADDRESS } from 'const'
...
export function getWeek(weekNumber: BigInt): Week {
  ...
  if (week === null) {
    let Distributor = HotpotDistributor.bind(HOTPOT_DISTRIBUTOR_ADDRESS)
